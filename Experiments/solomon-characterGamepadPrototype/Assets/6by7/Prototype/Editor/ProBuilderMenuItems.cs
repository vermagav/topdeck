...
#region WINDOW
	...
	[MenuItem("Tools/" + PRODUCT_NAME + "/" + PRODUCT_NAME + " Window", false, pb_Constant.MENU_WINDOW + 0)]
	...
	[MenuItem("Tools/ProBuilder/Texture Window _j", false, pb_Constant.MENU_WINDOW + 1)]
	#else
	...
	[MenuItem("Tools/" + PRODUCT_NAME + "/Shape Window %#k", false, pb_Constant.MENU_WINDOW + 2)]
	public static void ShapeMenu()
	{
		EditorWindow.GetWindow(typeof(pb_Geometry_Interface), true, "Shape Menu", true);
	}

	[MenuItem("Tools/" + PRODUCT_NAME + "/Vertex Colors Window", false, pb_Constant.MENU_WINDOW + 3)]
...
#region ProBuilder/Edit
	...
	[MenuItem("Tools/" + PRODUCT_NAME + "/Editor/Toggle Edit Level _g", true, pb_Constant.MENU_SELECTION + 0)]
	[MenuItem("Tools/" + PRODUCT_NAME + "/Editor/Toggle Selection Mode _h", true, pb_Constant.MENU_SELECTION + 1)]
	[MenuItem("Tools/" + PRODUCT_NAME + "/Editor/Toggle Handle Pivot _p", true, pb_Constant.MENU_SELECTION + 1)]
	...
	#if UNITY_STANDALONE_OSX
	[MenuItem("Tools/" + PRODUCT_NAME + "/Editor/Toggle Edit Level _g", false, pb_Constant.MENU_EDITOR + 0)]
	#else
	[MenuItem("Tools/" + PRODUCT_NAME + "/Editor/Toggle Edit Level", false, pb_Constant.MENU_EDITOR + 0)]
	#endif
	...
	#if UNITY_STANDALONE_OSX
	[MenuItem("Tools/" + PRODUCT_NAME + "/Editor/Toggle Selection Mode _h", false, pb_Constant.MENU_EDITOR + 1)]
	#else
	[MenuItem("Tools/" + PRODUCT_NAME + "/Editor/Toggle Selection Mode", false, pb_Constant.MENU_EDITOR + 1)]
	#endif
	...
	#if UNITY_STANDALONE_OSX
	[MenuItem("Tools/" + PRODUCT_NAME + "/Editor/Toggle Handle Pivot _p", false, pb_Constant.MENU_EDITOR + 2)]
	#else
	[MenuItem("Tools/" + PRODUCT_NAME + "/Editor/Toggle Handle Pivot", false, pb_Constant.MENU_EDITOR + 2)]
	#endif
	...
	[MenuItem("Tools/" + PRODUCT_NAME + "/Editor/Lightmap Settings Window", false, pb_Constant.MENU_EDITOR + 3)]
...
#region VERTEX COLORS
	...
	[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Vertex Colors/Set Selected Faces to Preset 1 &1")]
	public static void MenuSetVertexColorPreset1() {
		pb_VertexColorInterface.SetFaceColors(1);
	}

	[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Vertex Colors/Set Selected Faces to Preset 2 &2")]
	public static void MenuSetVertexColorPreset2() {
		pb_VertexColorInterface.SetFaceColors(2);
	}

	[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Vertex Colors/Set Selected Faces to Preset 3 &3")]
	public static void MenuSetVertexColorPreset3() {
		pb_VertexColorInterface.SetFaceColors(3);
	}

	[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Vertex Colors/Set Selected Faces to Preset 4 &4")]
	public static void MenuSetVertexColorPreset4() {
		pb_VertexColorInterface.SetFaceColors(4);
	}

	[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Vertex Colors/Set Selected Faces to Preset 5 &5")]
	public static void MenuSetVertexColorPreset5() {
		pb_VertexColorInterface.SetFaceColors(5);
	}

	[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Vertex Colors/Set Selected Faces to Preset 6 &6")]
	public static void MenuSetVertexColorPreset6() {
		pb_VertexColorInterface.SetFaceColors(6);
	}

	[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Vertex Colors/Set Selected Faces to Preset 7 &7")]
	public static void MenuSetVertexColorPreset7() {
		pb_VertexColorInterface.SetFaceColors(7);
	}

	[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Vertex Colors/Set Selected Faces to Preset 8 &8")]
	public static void MenuSetVertexColorPreset8() {
		pb_VertexColorInterface.SetFaceColors(8);
	}

	[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Vertex Colors/Set Selected Faces to Preset 9 &9")]
	public static void MenuSetVertexColorPreset9() {
		pb_VertexColorInterface.SetFaceColors(9);
	}

	[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Vertex Colors/Set Selected Faces to Preset 0 &0")]
